...
public class HospitalActivity extends AppCompatActivity {
    ...
    private TextView hospitalListTv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hospitalListTv = (TextView) findViewById(R.id.hospitallist_tv);

        String query = "select * from hospital";
        new JsonTask().execute(login_page.url+"/hospital.php?query="+query);
...
//            query_result.setText(result);
            String queryResult="Hospital     City     PhoneNo\n\n";
...
//               Toast.makeText(login_page.this, Integer.toString(temp), Toast.LENGTH_SHORT).show();
                hospitalListTv.setText(queryResult);
